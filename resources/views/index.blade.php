    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 mt-3 lg:right-0">
        <div class="flex flex-wrap items-center justify-center md:flex-row text-center lg:text-start">
            <div class="w-full px-4 lg:w-1/2">
                <h1 class="text-lg font-bold text-secondary mb-1 md:text-lg lg:text-2xl">Selamat Datang Di <span
                        class="block text-hitamCoklat text-5xl font-extrabold lg:text-7xl">Toko Endang</span></h1>
        ...
        <div class="mx-auto max-w-7xl py-6 lg:px-8 lg:right-0">
            ...
            <div class="grid grid-cols-1 gap-3 w-full px-8 md:grid-cols-3">
                <div class="flex justify-center flex-col text-center items-center">
                    <div
                        class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary lg:h-12 lg:w-12">
                    ...
                    <h4 class="font-bold text-lg text-secondary mb-2">Pengiriman Cepat</h4>
