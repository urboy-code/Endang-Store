<x-dashboard.layout>
    <div class="px-8 w-full pt-14 text-center uppercase">
        <h1 class="font-bold text-2xl text-dark lg:text-4xl">Produk</h1>
    </div>
    <div class=" overflow-x-auto py-16 mb-4">
                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap flex">
                            <a href="{{ route('product.edit', $product->id) }}"
                                class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 shadow-lg shadow-cyan-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Edit</a>
    ...
    <a href="{{ route('product.create') }}"
        class="ml-8 px-5 lg:ml-0 text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 shadow-lg shadow-green-500/50 font-bold rounded-lg text-sm py-2.5 text-center me-2 mb-2">Tambahkan
        Produk</a>
