<nav class="" x-data="{ isOpen: false }">
                    ...
                    <div class="relative ml-3" x-data="{ isOpen: false }">
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="h-8 w-8 rounded-full border border-slate-950"
                                    src="{{ asset('assets/images/bighead2.jpg') }}" alt="">
                            </button>
                        </div>
    ...
    <div x-show="isOpen" class="md:hidden bg-dark" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="{{ asset('assets/images/bighead2.jpg') }}" alt="">
                </div>
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Eka Setiyanto</div>
                    <div class="text-sm font-medium leading-none text-gray-400">kaankenn@gmail.com</div>
                </div>
                <button type="button"
